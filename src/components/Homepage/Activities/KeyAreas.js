...
export default function KeyAreas() {
  ...
  useEffect(function(){
    const keyValuesObserver = new IntersectionObserver((entries)=>{
  ...
  return (
    <div className="key-areas">
      <h1 className={visible?"visible" :""} ref={keyH1}>Our Key Focus Areas</h1>
      <hr/>
      <div ref={keyValues} className={`${visible ? "visible" : ""} lists-container`}>
        <div>
